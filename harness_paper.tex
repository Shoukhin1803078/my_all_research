...
\begin{figure*}[htb]
\centerline{\includegraphics[width=3.2in,height=2.2in,keepaspectratio]{fig/receipt_sample_a.jpg}\hspace{0.15in}\includegraphics[width=3.2in,height=2.2in,keepaspectratio]{fig/receipt_sample_b.jpg}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=3.4in]{fig/fig_harness_pipeline.png}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=3.3in]{fig/fig_benchmark_comparison.png}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=3.3in]{fig/fig_ece_literature_context.png}}
